    ...
    <div className="form">
        <Grid container component={Paper} direction="column" spacing={5}>
          ...
          <FormControl className={classes.margin}>
            ...
            >
              <MenuItem value={1}>MILWAUKEE BIT A</MenuItem>
              <MenuItem value={2}>MILWAUKEE BIT B</MenuItem>
              <MenuItem value={3}>SCHROEFJE KLEIN</MenuItem>
              <MenuItem value={4}>SCHROEFJE GROOT</MenuItem>
            </Select>
          </FormControl>
          <FormControl className={classes.margin}>
            <TextField
